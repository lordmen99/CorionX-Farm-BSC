...
import { Card, CardBody, Heading, OpenNewIcon, Text, Link as UIKitLink, Progress } from 'corx-ui'
  ...
  return (
    <Card>
      <CardBody>
        ...
        <Message>{TranslateString(999, 'NFTs can be traded in for CORX until the above block height')}</Message>
      </CardBody>
    </Card>
  )
}
