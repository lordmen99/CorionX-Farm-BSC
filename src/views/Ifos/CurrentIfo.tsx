...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from 'corx-ui'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy CORX and BNB tokens')}</li>
            <li>{TranslateString(598, 'Get CORX-BNB LP tokens by adding CORX and BNB liquidity')}</li>
          </List>
          <Flex mb="16px">
            <LinkExternal href="https://swap.oseeafoundation.org/#/swap" mr="16px">
              {TranslateString(999, 'Buy cake')}
            </LinkExternal>
            <LinkExternal href="https://swap.oseeafoundation.org/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
              {TranslateString(999, 'Get LP tokens')}
            </LinkExternal>
          </Flex>
          <Heading mb="16px">{TranslateString(600, 'During Sale')}:</Heading>
          <List>
            <li>{TranslateString(602, 'While the sale is live, commit your CORX-LP tokens to buy the IFO tokens')}</li>
          </List>
